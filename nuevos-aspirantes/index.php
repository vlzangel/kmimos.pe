...
<div style="position:absolute;right:0px;"class="col-sm-5 hidden-xs hidden-sm arrow-right"><img src="img/Arrow 1.png"></div>
	...
	<footer class="text-center ">
		...
		<div class="col-sm-12 margin-top-20">
			<a href="http://www.kmimos.pe/">¿Quieres Conocer Kmimos?</a>
		</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
			...
			<form id="frm-redirect" action="http://www.kmimos.pe/quiero-ser-cuidador-certificado-de-perros/"  method="post" >
      		</form>
	      </div>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
