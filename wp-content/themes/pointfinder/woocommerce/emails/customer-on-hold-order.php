 ...
 */
	...
	$dudas = '<p align="justify">Para cualquier duda y/o comentario puedes contactar al Staff Kmimos a los teléfonos (+57) 315 849.2186, o al correo contactoco@kmimos.la</p>';
	...
	if( $metas_orden["_payment_method"][0] == "openpay_stores" ){
		...
		*/
			...
			wp_mail( "contactoco@kmimos.la", "Solicitud de reserva #".$reserva->ID, $mensaje_admin);
